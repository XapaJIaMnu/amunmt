...
class FFNN:
    ...
    def __init__(self, hidden_layer=500, vocab_size=85000, batch_size=10000, w_1=None, b_1=None, model_filename=None):
        ...
        # init weights for layer1
        self.w_0 = None
        self.b_0 = None

        self.w_0 = self._init_weight((self.x_size, self.x_size), 'w0', self.w_0)
        self.b_0 = self._init_weight((1, self.x_size), 'b0', self.b_0)

        # init weights for output layer
        self.w_1 = None
        self.b_1 = None
    ...
    # @TODO: Activation? Regularization?
    def forwardpass(self):
        """Forward pass of the NN"""
        # Layer 0
        h0_out = tf.add(tf.matmul(self.X, self.w_0, name="X_W0"), self.b_0, name="h0_out")
        ...
        # Multiply with h_0 with W_1
        multiplication = tf.matmul(h0_out, selected_embeddings_w_1_t, name="X_W1_T")
